...
public final class transactionnewuser_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("        <title>Gift to a new user</title>\n");
      out.write("        <ul>\n");
      ...
      out.write("            <h1 class=\"w3-margin w3-jumbo\">Gift to a new user</h1>\n");
      out.write("          <form action=\"NewFriendTransactionServlet\" method=\"POST\">\n");
      out.write("              <label>Your friends email</label><br>\n");
      out.write("              <input type=\"text\" name=\"emailReceiver\" value=\"\" /><br>\n");
      out.write("              <label>Amount to give</label><br>\n");
      out.write("              <input type=\"text\" name=\"amount\" value=\"\" /><br>\n");
      out.write("              <label>Your alias</label><br>\n");
      out.write("              <input type=\"text\" name=\"alias\" value=\"\" /><br>\n");
      out.write("              <input type=\"submit\" value=\"Give\" name=\"submit\" />\n");
      out.write("        </form>\n");
      out.write("          ");
